			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 text-center slider-text">
				   				<div class="slider-text-inner">
				   					<h1>Contact Us</h1>
										<h2>Reach out to us we would love to hear from you</h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
